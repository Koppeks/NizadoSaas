...
type IconMenuActiveType = {
  active: boolean,
  color: "white" | "orange" | "black" | "gray"
}

export const IconMenuActive = forwardRef<HTMLDivElement, IconMenuActiveType> (({color ,active, ...props}, ref) => {
